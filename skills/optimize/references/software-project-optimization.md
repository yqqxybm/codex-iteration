...
## Understand The Improvement Before Selecting The Chain

Optimization is not selected by the word "optimize" or by the presence of
content that sounds improvable. Understand the purpose, concrete project
situation, and what makes a different realization worth pursuing. Existing
implementation and product shape are open to examination, not premises that
must be accepted before optimization can begin.

`project-lifecycle` selects the owner of the unresolved judgment: discovery when
user reality or the product object needs inquiry, brief when an understood
direction needs a product commitment, and analysis when the solution within
that commitment is unsettled. These are responsibility boundaries, not a split
between creative and diagnostic thinking.

## Improve The Governing Relation

Identify the purpose, its relationship to the surrounding
